                ...
                <div>
                    ...
                    <div className="mt-4">
                        <span className="text-2xl font-bold text-white mr-2">
                            ₹{selectedModel?.price || selectedColor?.price}
                        </span>
                        <span className="line-through text-gray-500 text-lg">
                            ₹{(selectedModel?.price * 1.15).toFixed()}
                        </span>
                    </div>
                    ...
                    <div className="mt-4">
                        ...
                        <div className="flex gap-2 ">
                            {product?.availableColors?.map((color, index) => (
                                <span
                                    key={index}
                                    className={`w-6 h-6 rounded-full border-2 cursor-pointer transition-all duration-200 ${selectedColorIndex === index
