...
const ProductListing = () => {
    ...
    return (
        <div className=" min-h-screen py-10 px-4 md:px-6 text-white font-sans">
                ...
                <div className="col-span-3">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                        {paginatedData.map((product) => (
                            <div
                                ...
                                className="bg-gradient-to-br from-[#1a1a1a] to-[#2a2a2a] p-5 rounded-2xl shadow-lg hover:shadow-teal-500/40 hover:scale-[1.03] transform transition duration-300 border border-transparent hover:border-teal-500"
                            >
                                <img
                                ...
                                <div className="mt-2">
                                    <span className="text-teal-400 text-lg font-bold mr-2">
                                ...
                                <div className="flex justify-between items-center mt-4">
                                    ...
                                    <Link
                                        ...
                                        className="bg-[#2dd4bf] hover:bg-[#2aa79b] text-white text-sm px-4 py-2 rounded-lg transition duration-200"
                                    >
                                        View Details
                                    </Link>
                                </div>
                    ...
                    <div className="flex justify-center mt-12 space-x-3">
                        <button
                            ...
                            className="px-4 py-2 bg-[#2dd4bf] hover:bg-[#2aa79b] text-white rounded-md disabled:opacity-40"
                        >
                            Prev
                        </button>
                        ...
                        {Array.from({ length: totalPages }, (_, i) => i + 1).map((page) => (
                            <button
                                ...
                                className={`px-4 py-2 rounded-md border transition duration-200 ${currentPage === page
                                    ...
                                    : 'bg-[#121212] border-gray-600 text-gray-300 hover:border-teal-500 hover:text-white'
                                    }`}
                            >
                                {page}
                            </button>
