    ...
    return (
        <div className=" text-white py-20 px-4">
            <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center  md:px-8">
                ...
                <div className="absolute -top-10 -left-10 w-96 h-96 bg-teal-500 opacity-20 blur-[120px] rounded-full z-0" />
                ...
                <div className="relative z-10 space-y-6">
                    <h1 className="text-3xl md:text-6xl font-extrabold leading-tight text-white drop-shadow-md">
                        Enter the <span className="text-teal-400">Next Level</span> of Gaming
                    </h1>
                    ...
                    <Link to={"/products"} className=''>
                        <button className="bg-teal-400 mt-5 hover:bg-teal-500 text-black text-lg px-6 py-3 rounded-xl shadow-lg flex items-center gap-2 transition-transform duration-200 hover:scale-105">
                ...
                <div className="relative z-10 ">
                    <div className="rounded-2xl overflow-hidden border-2 border-teal-500 shadow-xl hover:shadow-teal-400/30 transition-all duration-500">
                        <img
                            src="./homeLanding.svg"
                            alt="Gaming Setup"
            ...
            <div className="mt-24 xl:px-32">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 text-center">
                    <div className="bg-[#1f1f1f] p-8 rounded-2xl border border-gray-700 hover:border-teal-400 hover:shadow-teal-500/20 hover:shadow-xl transition-all duration-300">
